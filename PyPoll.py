...
# # Close the file.
# # election_data.close() Take off comment # when done!!!

# Add our dependencies.
import csv
import os
# Add a variable to load a file from a path.
file_to_load = os.path.join(r"C:\Users\Taxman\Election_Analysis_Final\Resources\election_results.csv")
# Add a variable to save the file to a path. C:\Users\Taxman\Election_Analysis_Final\Resources\election_results.csv
file_to_save = os.path.join(r"C:\Users\Taxman\Election_Analysis_Final\Resources\election_results.txt")
